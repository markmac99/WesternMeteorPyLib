...
if __name__ == "__main__":
    ...
    lat_list = np.linspace(np.radians(48.783253), np.radians(53.658340), 10)
    #lon_list = np.linspace(np.radians(-4.949858), np.radians(1.100422), 10)
    lon_list = np.linspace(np.radians(354.949858), np.radians(361.100422), 10)
    #lat_list = np.append(lat_list, np.radians(50.030404))
    #lat_list = np.append(lon_list, np.radians(51.425581))
